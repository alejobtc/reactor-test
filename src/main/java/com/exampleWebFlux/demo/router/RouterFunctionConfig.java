package com.exampleWebFlux.demo.router;

import com.exampleWebFlux.demo.handler.EjemploHandler;
...
public class RouterFunctionConfig {
    ...
    @Bean
    public RouterFunction<ServerResponse> route(EjemploHandler handlerFunction){
